...
sGRxWT.LL3=GRxWT.LL3[GRxWT.LL3$FDR<.1,]
upGR = sGRxWT.LL3[sGRxWT.LL3$logFC>0,]
downGR = sGRxWT.LL3[sGRxWT.LL3$logFC<0,]

sG85R_gbbxG85R.LL3=G85R_gbbxG85R.LL3[G85R_gbbxG85R.LL3<.1,]
down.gbb = sG85R_gbbxG85R.LL3[sG85R_gbbxG85R.LL3$logFC<0,]

up.gbb = sG85R_gbbxG85R.LL3[sG85R_gbbxG85R.LL3$logFC>0,]

GeneIDKey[intersect(row.names(upGR), row.names(down.gbb)),"Symbol"]
GeneIDKey[intersect(row.names(downGR), row.names(up.gbb)),"Symbol"]
...
metadata$ID = paste0(metadata$Genotypes, substr(metadata$Sample, 2,2))
...
metab.FC = data.frame(KEGG = KEGG.Key[row.names(GRxWT.C)],
                      'GRxWT.C' = log2(GRxWT.C$FC),
                      'GRxWT.Df' = log2(GRxWT.Df$FC),
                      'GRxWT.OE' = log2(GRxWT.OE$FC),
                      'GR.CxDf' = log2(GR.CxDf$FC),
                      'WT.CxDf' = log2(WT.CxDf$FC),
                      'GR.CxOE' = log2(GR.CxOE$FC),
                      'WT.CxOE' = log2(WT.CxOE$FC),
                      'GR.DfxWT.C' = log2(GR.DfxWT.C$FC),
                      'GR.OExWT.C' = log2(GR.OExWT.C$FC))
row.names(metab.FC) = row.names(GRxWT.C)



metab.FDR = data.frame(KEGG = KEGG.Key[row.names(GRxWT.C)],
                       GRxWT.C = GRxWT.C$p,
                       GRxWT.Df = GRxWT.Df$p,
                       GRxWT.OE = GRxWT.OE$p,
                       GR.CxDf = GR.CxDf$p,
...
#write.csv(metab.FC, "/Users/johncsantiago/Documents/GitHub/WhartonLab/GeneralDataFiles/MetaboliteFCs2.csv")
#write.csv(metab.FDR, "/Users/johncsantiago/Documents/GitHub/WhartonLab/GeneralDataFiles/MetaboliteFDRs2.csv")
#write.csv(norm.data, "/Users/johncsantiago/Documents/GitHub/WhartonLab/GeneralDataFiles/NormMetaboliteData.csv")
...
plot.SC = function(gene.name){
  SCdata$Gene.name = row.names(SCdata)
...
ID = "FBgn0023511"#Edem1
#ID = "FBgn0032480"#Edem2
ID = "FBgn0028325"
ID = "CG13603"
ID = "sick"
#d = dachs
