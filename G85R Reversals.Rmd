...
gene.set = intersect(gene.set, row.names(FDR.data)[FDR.data$GRxWT.FC < .05])
...
gene.set = intersect(gene.set, row.names(FDR.data)[FDR.data$GRxWT.MC < .05])
...
GeneIDKey[setdiff(setdiff(intersect(s3,s4), s1),s2),"Symbol"]

GeneIDKey[setdiff(setdiff(intersect(s1,s2), s3),s4),"Symbol"]
