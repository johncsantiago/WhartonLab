...
nodes = raw.nodes
  ...
  ##nebu/glut8 f-allele = no change, e-allele = no change
  ...
  #zw
  edges$color[edges$FBgn == "FBgn0004057"] = "gold"
  edges$width[edges$FBgn == "FBgn0004057"] = 5
  
  #Gapdh1
  edges$color[edges$FBgn == "FBgn0001091"] = "gold"
  edges$width[edges$FBgn == "FBgn0001091"] = 5
  
  #tkt
  edges$color[edges$FBgn == "FBgn0037607"] = "deeppink"
  edges$width[edges$FBgn == "FBgn0037607"] = 5
  
  #taldo
  edges$color[edges$FBgn == "FBgn0023477"] = "deepskyblue"
  edges$width[edges$FBgn == "FBgn0023477"] = 5
  
  #SdhBL
  edges$color[edges$FBgn == "FBgn0030975"] = "deepskyblue"
  edges$width[edges$FBgn == "FBgn0030975"] = 5

  
  visNetwork(nodes, edges, background = "white", main = "")%>%
    visNodes(physics = F)%>%
    #visLayout(hierarchical=F, improvedLayout=T)%>%
    visOptions(highlightNearest = TRUE, nodesIdSelection = list(enabled = T, values = nodes[nodes$size > 0, "label"]))%>%
    visNodes(font = list(color = "black", size = 10, background = "white"))%>%
