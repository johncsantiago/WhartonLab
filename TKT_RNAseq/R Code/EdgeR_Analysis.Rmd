...
- #### Figure \@ref(fig:fig3): MDS plot, all samples

- #### Figure \@ref(fig:fig4): Barplot of Total DEGs

### Male and Female samples processed separately with TEs and outlier libraries removed
- #### Figure \@ref(fig:fig5): MDS plot of female samples only

- #### Figure \@ref(fig:fig6): MDS plot of male samples only

- #### Figure \@ref(fig:fig7): Barplot of Total DEGs
...
```{r fig1, echo = F, warning=F, fig.height=10, fig.width=10, fig.cap= 'MDS plot, all samples.'}
...
```{r fig2, echo = F, fig.cap='Barplot of Total DEGs, all samples.'}
...
```{r fig3, echo = F, warning=F, fig.height=10, fig.width=10, fig.cap= 'MDS plot, all samples, TEs and outlier libraries removed.'}
...
```{r fig4, echo = F, fig.cap='Barplot of Total DEGs, all samples, TEs and outlier libraries removed.'}
...
```{r fig5, echo = F, warning=F, fig.height=10, fig.width=10, fig.cap= 'MDS plot, females only, TEs and outliers removed.'}
...
```{r fig6, echo = F, warning=F, fig.height=10, fig.width=10, fig.cap= 'MDS plot, males, TEs and outlier libraries removed.'}
...
```{r fig7, echo = F, fig.cap='Barplot of Total DEGs, males and females processed separately, TEs and outlier libraries removed.'}
...
```{r echo = F, fig.cap='Barplot of Total DEGs excluding TEs.'}
...
```{r echo = F, fig.height=10, fig.cap='Heatmaps of Total DEGs in GR.FC x GR.FDf.'}
