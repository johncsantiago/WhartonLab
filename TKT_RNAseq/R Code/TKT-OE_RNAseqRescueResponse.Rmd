...
mean.data = G85R.meancpm[, c('GR.F', 'GR.M',
                             'TktOEGR.F', 'TktOEGR.M')]
main.title = "G85R Control vs TKT-OE: Female and Male DE Genes"


##RG = Response Genes
GR.CxOE.RG = TKT.biplot(x, y, mean.data, main.title)
...
s1 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC1'] > 0, "FBgn"]
s2 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC1'] < 0, "FBgn"]
s3 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR2'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC2'] > 0, "FBgn"]
s4 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR2'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC2'] < 0, "FBgn"]
...
##items to be compared (ex: gene names) as a 1 dimensional vectors. Only give inputs up to your number of selected categories
s3 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC1'] > 0, "FBgn"]
s1 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC1'] < 0, "FBgn"]
s4 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR2'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC2'] > 0, "FBgn"]
s2 = GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR2'] <= 0.05 &
                     GR.CxOE.RG[[2]][,'FC2'] < 0, "FBgn"]
...
GR.CxOE.MF.Enr = Subset.Enrichment(bg, MF.shared.DEGs)
...
F.only.DEGs = c(setdiff(GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05, "FBgn"],
                        GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR2'] <= 0.05, "FBgn"]))

bg = row.names(TKT.EdgeR)
GR.CxOE.Fonly.Enr = Subset.Enrichment(bg, F.only.DEGs)
...
M.only.DEGs = c(setdiff(GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR2'] <= 0.05, "FBgn"],
                        GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05, "FBgn"]))

bg = row.names(TKT.EdgeR)
GR.CxOE.Monly.Enr = Subset.Enrichment(bg, M.only.DEGs)


```

##no significantly enriched GO terms in sex independent or sex dependent DEG sets
...
F.DEGs = c(GR.CxOE.RG[[2]][GR.CxOE.RG[[2]][,'FDR1'] <= 0.05, "FBgn"])

bg = row.names(TKT.EdgeR)
GR.CxOE.F.Enr = Subset.Enrichment(bg, F.DEGs)
...
RTCC.GR.CxOE.F = tree(GR.CxOE.F.Enr, "CC")
treemapPlot(RTCC.GR.CxOE.F)
