...
##Veronica genes: code to update data table

ver=read.csv("/Users/johncsantiago/Desktop/VeronicaGenes.csv")
i=1
while(i<=nrow(ver)){
  ver.def = genesindf[genesindf$FBgn == ver$FBgn[i],"Df"]
  ver.mle = fullDfKey[fullDfKey$Deficiency %in% ver.def, "MLE"]
  ver$MLE[i] = ver.mle[1]
  j=2
  while(j<=length(ver.mle)){
    ver$MLE[i] = paste0(ver$MLE[i], ", ", ver.mle[j])
    j=j+1
  }
  i=i+1
}

#write.csv(ver,"/Users/johncsantiago/Desktop/VeronicaGenes.csv", row.names=T)
  

ver=read.csv("/Users/johncsantiago/Desktop/VeronicaGenes.csv", row.names = 1)

ver$Fsig = G85R.geneFDR[ver$FBgn, "GRxWT.FC"]<.05

ver$Fsig[ver$Fsig == TRUE] = "sig." 
ver$Fsig[ver$Fsig == FALSE] = "not sig." 

ver$Fdir = G85R.geneFC[ver$FBgn, "GRxWT.FC"]
ver$Fdir[G85R.geneFC[ver$FBgn, "GRxWT.FC"] >0] = "Up"
ver$Fdir[G85R.geneFC[ver$FBgn, "GRxWT.FC"] <0] = "Down"
ver$G85R.Female = paste(ver$Fsig, ver$Fdir)

ver$Msig = G85R.geneFDR[ver$FBgn, "GRxWT.MC"]<.05

ver$Msig[ver$Msig == TRUE] = "sig." 
ver$Msig[ver$Msig == FALSE] = "not sig." 

ver$Mdir = G85R.geneFC[ver$FBgn, "GRxWT.MC"]
ver$Mdir[G85R.geneFC[ver$FBgn, "GRxWT.MC"] >0] = "Up"
ver$Mdir[G85R.geneFC[ver$FBgn, "GRxWT.MC"] <0] = "Down"
ver$G85R.Male = paste(ver$Msig, ver$Fdir)

#write.csv(ver,"/Users/johncsantiago/Desktop/VeronicaGenes.csv", row.names=T)


G85R.geneFDR[ver$FBgn[ver$G85R.Female == "sig. Up"],
            c("GRF.CxDf", "GRF.CxOE")]

G85R.geneFDR[ver$FBgn[ver$G85R.Female == "sig. Down"],
            c("GRF.CxDf", "GRF.CxOE")]

G85R.geneFDR[ver$FBgn[ver$G85R.Male == "sig. Up"],
            c("GRM.CxDf", "GRM.CxOE")]

G85R.geneFC[ver$FBgn[ver$G85R.Male == "sig. Up"],
            c("GRM.CxDf", "GRM.CxOE")]

G85R.geneFDR[ver$FBgn[ver$G85R.Male == "sig. Down"],
            c("GRM.CxDf", "GRM.CxOE")]

G85R.geneFC[ver$FBgn[ver$G85R.Male == "sig. Down"],
            c("GRM.CxDf", "GRM.CxOE")]


ver=read.csv("/Users/johncsantiago/Desktop/VeronicaGenes.csv", row.names = 1)

ver.sig = A4V.FDR[ver$FBgn, "AvS3FH"]  
ver.fc = A4V.FC[ver$FBgn, "AvS3FH"] 
ver$A4V.Female.Head.sig.FC = "-"
ver$A4V.Female.Head.sig.FC[ver.sig <.05 & ver.fc >0] = "Up"
ver$A4V.Female.Head.sig.FC[ver.sig <.05 & ver.fc <0] = "Down"


ver.sig = A4V.FDR[ver$FBgn, "AvS3FT"]  
ver.fc = A4V.FC[ver$FBgn, "AvS3FT"] 
ver$A4V.Female.Thorax.sig.FC = "-"
ver$A4V.Female.Thorax.sig.FC[ver.sig <.05 & ver.fc >0] = "Up"
ver$A4V.Female.Thorax.sig.FC[ver.sig <.05 & ver.fc <0] = "Down"

ver.sig = A4V.FDR[ver$FBgn, "AvS3FA"]  
ver.fc = A4V.FC[ver$FBgn, "AvS3FA"] 
ver$A4V.Female.Abdomen.sig.FC = "-"
ver$A4V.Female.Abdomen.sig.FC[ver.sig <.05 & ver.fc >0] = "Up"
ver$A4V.Female.Abdomen.sig.FC[ver.sig <.05 & ver.fc <0] = "Down"


ver.sig = A4V.FDR[ver$FBgn, "AvS9FH"]  
ver.fc = A4V.FC[ver$FBgn, "AvS9FH"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Female.Head.sig.FC =
  paste0(ver$A4V.Female.Head.sig.FC,
        "/",ver.sfc)

ver.sig = A4V.FDR[ver$FBgn, "AvS9FT"]  
ver.fc = A4V.FC[ver$FBgn, "AvS9FT"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Female.Thorax.sig.FC =
  paste0(ver$A4V.Female.Thorax.sig.FC,
        "/",ver.sfc)


ver.sig = A4V.FDR[ver$FBgn, "AvS9FA"]  
ver.fc = A4V.FC[ver$FBgn, "AvS9FA"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Female.Abdomen.sig.FC =
  paste0(ver$A4V.Female.Abdomen.sig.FC,
        "/",ver.sfc)


ver.sig = A4V.FDR[ver$FBgn, "AvS40FH"]  
ver.fc = A4V.FC[ver$FBgn, "AvS40FH"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Female.Head.sig.FC =
...
ver.sig = A4V.FDR[ver$FBgn, "AvS40FT"]  
ver.fc = A4V.FC[ver$FBgn, "AvS40FT"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Female.Thorax.sig.FC =
...
ver.sig = A4V.FDR[ver$FBgn, "AvS40FA"]  
ver.fc = A4V.FC[ver$FBgn, "AvS40FA"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Female.Abdomen.sig.FC =
...
ver.sig = A4V.FDR[ver$FBgn, "AvS3MH"]  
ver.fc = A4V.FC[ver$FBgn, "AvS3MH"] 
ver$A4V.Male.Head.sig.FC = "-"
ver$A4V.Male.Head.sig.FC[ver.sig <.05 & ver.fc >0] = "Up"
ver$A4V.Male.Head.sig.FC[ver.sig <.05 & ver.fc <0] = "Down"


ver.sig = A4V.FDR[ver$FBgn, "AvS3MT"]  
ver.fc = A4V.FC[ver$FBgn, "AvS3MT"] 
ver$A4V.Male.Thorax.sig.FC = "-"
ver$A4V.Male.Thorax.sig.FC[ver.sig <.05 & ver.fc >0] = "Up"
ver$A4V.Male.Thorax.sig.FC[ver.sig <.05 & ver.fc <0] = "Down"

ver.sig = A4V.FDR[ver$FBgn, "AvS3MA"]  
ver.fc = A4V.FC[ver$FBgn, "AvS3MA"] 
ver$A4V.Male.Abdomen.sig.FC = "-"
ver$A4V.Male.Abdomen.sig.FC[ver.sig <.05 & ver.fc >0] = "Up"
ver$A4V.Male.Abdomen.sig.FC[ver.sig <.05 & ver.fc <0] = "Down"


ver.sig = A4V.FDR[ver$FBgn, "AvS9MH"]  
ver.fc = A4V.FC[ver$FBgn, "AvS9MH"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Male.Head.sig.FC =
  paste0(ver$A4V.Male.Head.sig.FC,
        "/",ver.sfc)

ver.sig = A4V.FDR[ver$FBgn, "AvS9MT"]  
ver.fc = A4V.FC[ver$FBgn, "AvS9MT"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Male.Thorax.sig.FC =
  paste0(ver$A4V.Male.Thorax.sig.FC,
        "/",ver.sfc)


ver.sig = A4V.FDR[ver$FBgn, "AvS9MA"]  
ver.fc = A4V.FC[ver$FBgn, "AvS9MA"] 
ver.sfc = rep("-", nrow(ver))
ver.sfc[ver.sig <.05 & ver.fc >0] = "Up"
ver.sfc[ver.sig <.05 & ver.fc <0] = "Down"
ver$A4V.Male.Abdomen.sig.FC =
  paste0(ver$A4V.Male.Abdomen.sig.FC,
        "/",ver.sfc)
...
while(i <= nrow(sig.GO.terms)){
  ...
  notsig.df.data = notsig.df.data[notsig.df.data$Df %in% tempfdk[tempfdk$MLE < 2, "Deficiency"],]
  ...
  temp.plot.godf = data.frame(GO = sig.GO.terms$term[i],
                              ...
                              notsig.Dfs.inCat = length(unique(notsig.df.data$Df)),
...
plot.godf$notsigGenetoDf.ratio = signif((plot.godf$total - plot.godf$totalsigs)
                                     /(plot.godf$notsig.Dfs - plot.godf$sig.Dfs),3)
 

plot.godf$sigsperkb = signif(plot.godf$totalsigs/plot.godf$sig.Df.length,3)
plot.godfgenesperkb = signif(plot.godf$total/plot.godf$notsig.Df.length ,3)
...
fig2 <- plot_ly(data = plotly.godf,
               ...
               hovertext = paste("Sample:", plotly.godf$GO,
                                 ...
                                 "\nTotal sig Df: ", plotly.godf$sig.Dfs.inCat,
                                 "\nTotal non sig Df: ", plotly.godf$notsig.Dfs.inCat,
...
```{r echo = F}
#new plot idea, scatterplot where we have:
...
other.suppressors = read.csv("/Users/johncsantiago/Documents/GitHub/WhartonLab/C9ORF-G4C2_DrosophilaModifers.csv")[,2]

other.suppressors = intersect(other.suppressors, GeneIDKey$Symbol)

id.validated.suppressors =read.csv("/Users/johncsantiago/Documents/GitHub/WhartonLab/C9ORF-G4C2_DrosophilaModifers_IDvalidation.csv")[,2]
id.validated.suppressors=GeneIDKey[GeneIDKey$FBgn %in% id.validated.suppressors, "Symbol"]

other.suppressors = unique(c(other.suppressors, id.validated.suppressors))

exelixis = read.csv("/Users/johncsantiago/Documents/GitHub/WhartonLab/ExelixisScreenTargets.csv")[,1]
exelixis=GeneIDKey[exelixis,"Symbol"]

other.suppressors = unique(c(other.suppressors, exelixis))

other.suppressors = intersect(other.suppressors, GeneIDKey$Symbol)

tested.other.suppressors = genesindf[genesindf$Symbol %in% other.suppressors,]

untested.other.suppressors = setdiff(other.suppressors, tested.other.suppressors$Symbol)

temp.dfkey = fullDfKey
row.names(temp.dfkey) = temp.dfkey$Deficiency
tested.other.suppressors$MLE = temp.dfkey[tested.other.suppressors$Df, "MLE"]

##255 unique gene symbols in original table
##I found FBgn data for 244
##195 were tested
##49 were not in Dfs
untested.suppressors = data.frame(Df = NA,
                                  FBgn = GeneIDKey[GeneIDKey$Symbol %in% untested.other.suppressors, "FBgn"],
                                  Symbol = untested.other.suppressors,
                                  MLE = NA)

other.suppressors.comparison = rbind(tested.other.suppressors,
                                     untested.suppressors)


other.suppressors.comparison$MLE = floor(other.suppressors.comparison$MLE)

other.suppressors.comparison$MLE = factor(other.suppressors.comparison$MLE, levels = unique(other.suppressors.comparison$MLE)[order(unique(other.suppressors.comparison$MLE))])
plot.data = summary(other.suppressors.comparison$MLE)

barplot(height = as.numeric(plot.data),
        names.arg = names(plot.data),
        xlab ="MLE",
        ylab = "Number of genes",
        ylim = c(0,80))
abline(h = seq(0, 80, length.out = 17),
       lty = 2,
       col = hex("grey", .5))
