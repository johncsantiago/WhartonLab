...
plot.MLE("FBgn0014861")
plot.MLE("FBgn0284442")
plot.MLE("FBgn0017577")
plot.MLE("FBgn0025815")
plot.MLE("FBgn0030716")
plot.MLE("FBgn0266916")

```

```{r}

FDR = data.frame(Gene = c("FBgn0014861",
                          "FBgn0284442",
                          "FBgn0017577",
                          "FBgn0025815",
                          "FBgn0030716",
...
i=1
while(i<= 6){
  FDR[,names(all.comparisons)[i]] = all.comparisons[[i]][FDR$Gene, "FDR"]
  i=i+1
}
